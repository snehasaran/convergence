...
public class SnehaAdminHome 
{
	...
	public void displayRequests()
	{
		...
		try{
			...
			while(rs.next()){
				...
				System.out.println(group_id[i] + " " + group_name[i]);
				i++;
			}
	...
	public void createGroup(String group_name)
	{
		...
		try{
			...
			createGrpQuery = "INSERT INTO groups (group_name) VALUES (?)";
			
			PreparedStatement preparedStatement = getConnection().prepareStatement(createGrpQuery);
			preparedStatement.setString(1, this.groupNameToInsert);
